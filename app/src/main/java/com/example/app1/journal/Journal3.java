...
public class Journal3 extends AppCompatActivity {
    ...
    CircularProgressButton savesButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savesButton = findViewById(R.id.updateButton);
       ...
       // addPhotoButton.setOnClickListener(this);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Journal3.this, Journal4.class));
            }
        });
        ...
        if (JournalApi.getInstance() != null) {
            ...
            currentUserTextView.setText("what's on your mind," + currentUserName+"...");
        }
                                    ...
                                    collectionReference.add(journal)
                                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                ...
                                                public void onSuccess(DocumentReference documentReference) {
                                                    ...
                                                    startActivity(new Intent(Journal3.this,
                                                            Journal4.class));
                                                    finish();
                                                }
                                            })
