...
public class signUpp extends AppCompatActivity {
    ...
    CircularProgressButton createAcctButton;
    ImageView logButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAcctButton = findViewById(R.id.updateButton);
        emailEditText = findViewById(R.id.email_accounts);
        passwordEditText = findViewById(R.id.password_accounts);
        userNameEditText = findViewById(R.id.username_accountsz);

        logButton = findViewById(R.id.logButtons);

        logButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(signUpp.this, loginn.class));
            }
        });
        ...
        createAcctButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(emailEditText.getText().toString())
                    ...
                    createAcctButton.startAnimation();
                                                        ...
                                                        .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                                if (Objects.requireNonNull(task.getResult()).exists()) {
                                                                    ...
                                                                    Intent intent = new Intent(signUpp.this,
                                                                            Dashboard.class);
