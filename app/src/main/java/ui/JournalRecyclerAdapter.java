...
public class JournalRecyclerAdapter extends RecyclerView.Adapter<JournalRecyclerAdapter.ViewHolder> {
    ...
    public JournalRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.journal_rows, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, Context ctx) {
            ...
            title = itemView.findViewById(R.id.title_lists);
            thoughts = itemView.findViewById(R.id.journal_thought_lists);
            dateAdded = itemView.findViewById(R.id.journal_timestamp_lists);
            image = itemView.findViewById(R.id.weatherImages);
